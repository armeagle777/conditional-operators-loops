...
console.log(
  `in case (45, 90) Third angle is equal : ${triangleThirdAngle(45, 90)}`
);
console.log(
  `in case (30, 30) Third angle is equal : ${triangleThirdAngle(30, 30)}`
);
console.log(
  `in case (75, 25) Third angle is equal : ${triangleThirdAngle(75, 25)}`
);
